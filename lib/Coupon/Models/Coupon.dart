...
class Coupon {
  ...
  Coupon({this.id, this.couponID, this.title, this.description, this.couponCode, this.periodStart, this.periodEnd, this.useFor, this.url, this.state, this.type, this.createdAt, this.updatedAt, this.color});
